...
#define OLED_DC_Set()   DL_GPIO_setPins(SPI_OLED_SPI_OLED_DS_PORT, SPI_OLED_SPI_OLED_DS_PIN)
#define OLED_DC_Clr()   DL_GPIO_clearPins(SPI_OLED_SPI_OLED_DS_PORT, SPI_OLED_SPI_OLED_DS_PIN)
